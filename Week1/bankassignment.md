# Bank Assignment - First Iteration
## Due 3/5 at 9AM
```
Create a mock bank using solely Java 1.8. Persist your data in a text file. You may also write functionality to serialize your bank after every transaction but this is not a requirement.
